...
namespace ProyectSecret.Areas.Damage
{
    public class AreaDamage : MonoBehaviour
    {
        ...
        /// <summary>
        /// Evento público para notificar cuando un objeto entra en el área de daño.
        /// </summary>
        public event System.Action<GameObject> OnObjectEnteredArea;

        /// <summary>
        /// Evento público para notificar cuando un objeto sale del área de daño.
        /// </summary>
        public event System.Action<GameObject> OnObjectExitedArea;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            OnObjectEnteredArea?.Invoke(other.gameObject);
        }
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            if (timer != null)
                Destroy(timer);
            OnObjectExitedArea?.Invoke(other.gameObject);
        }
    }
}

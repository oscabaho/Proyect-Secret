...
namespace ProyectSecret.Inventory.Items
{
    ...
    public class HealingItem : ScriptableObject, IUsableItem
    {
        ...
        /// <summary>
        /// Evento público para notificar que el ítem curativo fue usado (útil para logros, UI, etc).
        /// </summary>
        public event System.Action<GameObject, int> OnHealed;
        ...
        public void Use(GameObject user)
        {
            ...
            if (health != null && health.Health != null)
            {
                ...
                OnHealed?.Invoke(user, healAmount);
            }
            else
            {

...
namespace ProyectSecret.Combat.Behaviours
{
    ...
    public class AttackComponent : MonoBehaviour
    {
        ...
        /// <summary>
        /// Evento público para notificar un ataque exitoso a otros sistemas (UI, logros, etc).
        /// </summary>
        public event System.Action OnAttackSuccess;
        ...
        public void TryAttack()
        {
            ...
            if (staminaBehaviour == null || staminaBehaviour.Stamina == null)
                staminaBehaviour = NullStaminaComponentBehaviour.Instance;

            if (staminaBehaviour.Stamina.CurrentStamina >= staminaCost)
            {
        ...
        /// <summary>
        /// Implementación Null Object para StaminaComponentBehaviour, evita comprobaciones de null.
        /// </summary>
        private class NullStaminaComponentBehaviour : StaminaComponentBehaviour
        {
            public static readonly StaminaComponentBehaviour Instance = new NullStaminaComponentBehaviour();
            public override StaminaComponent Stamina => ProyectSecret.Components.NullObjects.NullStaminaComponent.Instance;
        }
    }
}
